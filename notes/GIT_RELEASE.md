...
Depending on Angular version, the build might create a subfolder `docs/browser/`. 
Move all files to the root docs/:
``` sh
...
### 5️⃣ Push the build to GitHub git add docs git commit -m "Release: deploy Angular build" git push 
